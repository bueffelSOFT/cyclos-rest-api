...
class PaymentsApi
{
     ...
     */
    public function calculatePerformPaymentInstallments($owner, $to, $count, $amount, $fields = null, $currency = null, $type = null, $first_date = null)
    {
        list($response) = $this->calculatePerformPaymentInstallmentsWithHttpInfo($owner, $to, $count, $amount, $fields, $currency, $type, $first_date);
        return $response;
    }
     ...
     */
    public function calculatePerformPaymentInstallmentsWithHttpInfo($owner, $to, $count, $amount, $fields = null, $currency = null, $type = null, $first_date = null)
    {
        $returnType = '\Cyclos\Api\Model\PerformScheduledPaymentInstallment[]';
        $request = $this->calculatePerformPaymentInstallmentsRequest($owner, $to, $count, $amount, $fields, $currency, $type, $first_date);
     ...
     */
    public function calculatePerformPaymentInstallmentsAsync($owner, $to, $count, $amount, $fields = null, $currency = null, $type = null, $first_date = null)
    {
        return $this->calculatePerformPaymentInstallmentsAsyncWithHttpInfo($owner, $to, $count, $amount, $fields, $currency, $type, $first_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calculatePerformPaymentInstallmentsAsyncWithHttpInfo($owner, $to, $count, $amount, $fields = null, $currency = null, $type = null, $first_date = null)
    {
        $returnType = '\Cyclos\Api\Model\PerformScheduledPaymentInstallment[]';
        $request = $this->calculatePerformPaymentInstallmentsRequest($owner, $to, $count, $amount, $fields, $currency, $type, $first_date);
     ...
     */
    protected function calculatePerformPaymentInstallmentsRequest($owner, $to, $count, $amount, $fields = null, $currency = null, $type = null, $first_date = null)
    {
     ...
     */
    public function dataForPerformPayment($owner, $fields = null, $to = null, $type = null)
    {
        list($response) = $this->dataForPerformPaymentWithHttpInfo($owner, $fields, $to, $type);
        return $response;
    }
     ...
     */
    public function dataForPerformPaymentWithHttpInfo($owner, $fields = null, $to = null, $type = null)
    {
        $returnType = '\Cyclos\Api\Model\DataForTransaction';
        $request = $this->dataForPerformPaymentRequest($owner, $fields, $to, $type);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dataForPerformPaymentAsync($owner, $fields = null, $to = null, $type = null)
    {
        return $this->dataForPerformPaymentAsyncWithHttpInfo($owner, $fields, $to, $type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function dataForPerformPaymentAsyncWithHttpInfo($owner, $fields = null, $to = null, $type = null)
    {
        $returnType = '\Cyclos\Api\Model\DataForTransaction';
        $request = $this->dataForPerformPaymentRequest($owner, $fields, $to, $type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function dataForPerformPaymentRequest($owner, $fields = null, $to = null, $type = null)
    {
        // verify the required parameter 'owner' is set
        if ($owner === null || (is_array($owner) && count($owner) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function performPayment($body, $owner, $confirmation_password = null, $fields = null)
    {
        list($response) = $this->performPaymentWithHttpInfo($body, $owner, $confirmation_password, $fields);
        return $response;
    }
     ...
     */
    public function performPaymentWithHttpInfo($body, $owner, $confirmation_password = null, $fields = null)
    {
        $returnType = '\Cyclos\Api\Model\Transaction';
        $request = $this->performPaymentRequest($body, $owner, $confirmation_password, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function performPaymentAsync($body, $owner, $confirmation_password = null, $fields = null)
    {
        return $this->performPaymentAsyncWithHttpInfo($body, $owner, $confirmation_password, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function performPaymentAsyncWithHttpInfo($body, $owner, $confirmation_password = null, $fields = null)
    {
        $returnType = '\Cyclos\Api\Model\Transaction';
        $request = $this->performPaymentRequest($body, $owner, $confirmation_password, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function performPaymentRequest($body, $owner, $confirmation_password = null, $fields = null)
    {
     ...
     */
    public function previewPayment($body, $owner, $fields = null)
    {
        list($response) = $this->previewPaymentWithHttpInfo($body, $owner, $fields);
        return $response;
    }
     ...
     */
    public function previewPaymentWithHttpInfo($body, $owner, $fields = null)
    {
        $returnType = '\Cyclos\Api\Model\PaymentPreview';
        $request = $this->previewPaymentRequest($body, $owner, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function previewPaymentAsync($body, $owner, $fields = null)
    {
        return $this->previewPaymentAsyncWithHttpInfo($body, $owner, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function previewPaymentAsyncWithHttpInfo($body, $owner, $fields = null)
    {
        $returnType = '\Cyclos\Api\Model\PaymentPreview';
        $request = $this->previewPaymentRequest($body, $owner, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function previewPaymentRequest($body, $owner, $fields = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling previewPayment'
            );
        }
        // verify the required parameter 'owner' is set
        if ($owner === null || (is_array($owner) && count($owner) === 0)) {
