 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContactListQueryFilters extends QueryFilters 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContactListQueryFilters';
...
'order_by' => '\Cyclos\Api\Model\ContactOrderByEnum'    ];
...
'order_by' => 'getOrderBy'    ];
     ...
     * Sets keywords
     *
     * @param string $keywords Textual search keywords. Sometimes, like in user search, the fields matched depends on what is configured on the products.
     *
     * @return $this
     */
     ...
     * Gets order_by
     *
     * @return \Cyclos\Api\Model\ContactOrderByEnum
     */
     ...
     * Sets order_by
     *
     * @param \Cyclos\Api\Model\ContactOrderByEnum $order_by order_by
     *
     * @return $this
     */
