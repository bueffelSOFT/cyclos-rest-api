...
class TransferKind
{
     ...
     */
    const ACCOUNT_FEE = 'accountFee';
const CHARGEBACK = 'chargeback';
const IMPORT = 'import';
const INITIAL_CREDIT = 'initialCredit';
const PAYMENT = 'payment';
const RECURRING_PAYMENT = 'recurringPayment';
const SCHEDULED_PAYMENT_INSTALLMENT = 'scheduledPaymentInstallment';
...
self::SCHEDULED_PAYMENT_INSTALLMENT,
self::TRANSFER_FEE,        ];
    }
}
