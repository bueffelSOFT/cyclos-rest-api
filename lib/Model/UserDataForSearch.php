 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserDataForSearch extends BaseUserDataForSearch 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserDataForSearch';
...
'groups_for_registration' => '\Cyclos\Api\Model\Group[]',
'query' => '',
...
'statuses' => 'getStatuses'    ];
     ...
     * Sets broker
     *
     * @param  $broker When a `broker` parameter was set when getting the data, contains the details of the broker
     *
     * @return $this
     */
     ...
     *
     * @param \Cyclos\Api\Model\Group[] $groups_for_registration Possible groups an administrator or broker can use to register users
     *
     * @return $this
     */
     ...
     * Sets query
     *
     * @param  $query Default query filters to search users
     *
     * @return $this
     */
     ...
     * Sets statuses
     *
     * @param \Cyclos\Api\Model\UserStatusEnum[] $statuses The possible user statuses the authenticated user can use to filter the search. Only administrators or brokers over their members can filter by status (also depends on permissions)
     *
     * @return $this
     */
