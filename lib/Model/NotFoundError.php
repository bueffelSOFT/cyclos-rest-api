...
'key' => 'getKey'    ];
     ...
     * Sets entity_type
     *
     * @param string $entity_type The name of the entity being attempted, but not found
     *
     * @return $this
     */
     ...
     * Sets key
     *
     * @param string $key The identifier used to attempt to find the entity, such as id, internal name, principal, etc
     *
     * @return $this
     */
