 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Currency extends InternalNamedEntity 
{
...
'decimal_digits' => 'getDecimalDigits'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['transaction_number_pattern'] = isset($data['transaction_number_pattern']) ? $data['transaction_number_pattern'] : null;
     ...
     * Sets prefix
     *
     * @param string $prefix The currency prefix when formatting numbers
     *
     * @return $this
     */
     ...
     * Sets suffix
     *
     * @param string $suffix The currency suffix when formatting numbers
     *
     * @return $this
     */
     ...
     *
     * @param string $transaction_number_pattern If transaction number is enabled for this currency, contains the pattern which is expected, in case of rendering a field for users to type in a transaction number
     *
     * @return $this
     */
     ...
     * Sets decimal_digits
     *
     * @param int $decimal_digits The number of decimal digits used by this currency
     *
     * @return $this
     */
