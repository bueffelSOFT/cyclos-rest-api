...
'authorization_status' => 'getAuthorizationStatus'    ];
     ...
     * Sets display
     *
     * @param string $display The descriptive text for this transaction, according to the transaction type and currency configuration in Cyclos
     *
     * @return $this
     */
     ...
     * Sets ticket_number
     *
     * @param string $ticket_number A 32-length alphanumeric ticket identifier. Only returned if kind is `ticket`.
     *
     * @return $this
     */
     ...
     * Sets from_kind
     *
     * @param  $from_kind The from account kind
     *
     * @return $this
     */
     ...
     * Sets from_user
     *
     * @param  $from_user The user that performed this transaction. Is only returned if `fromKind` is `user`.
     *
     * @return $this
     */
     ...
     * Sets to_kind
     *
     * @param  $to_kind The to account kind
     *
     * @return $this
     */
     ...
     * Sets to_user
     *
     * @param  $to_user The user that performed this transaction. Is only returned if `toKind` is `user`.
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param  $currency The transaction currency. Is only returned if this object is not embedded in a `TransferView`.
     *
     * @return $this
     */
