 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OperatorGroupView extends NamedEntity 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OperatorGroupView';
...
'unblock_token' => 'bool',
'brokering' => 'bool',
'restrict_payments_to_users' => '\Cyclos\Api\Model\User[]',
'operations' => '\Cyclos\Api\Model\Operation[]',
'records' => '\Cyclos\Api\Model\RecordType[]',
'accounts' => '\Cyclos\Api\Model\OperatorGroupAccountView[]',
'payments' => '\Cyclos\Api\Model\OperatorGroupPaymentView[]'    ];
...
'payments' => 'getPayments'    ];
     ...
     * Sets user
     *
     * @param  $user The user which owns this operator group
     *
     * @return $this
     */
     ...
     * Sets editable
     *
     * @param bool $editable Can the authenticated user edit / remove this operator group?
     *
     * @return $this
     */
     ...
     * Sets brokering
     *
     * @param bool $brokering Can operators of this group perform brokering operations?
     *
     * @return $this
     */
     ...
     *
     * @param \Cyclos\Api\Model\User[] $restrict_payments_to_users When set, operators of this group will only be able to perform payments to one of this users
     *
     * @return $this
     */
     ...
     * Sets operations
     *
     * @param \Cyclos\Api\Model\Operation[] $operations Custom operators that operators of this group will only be able to run
     *
     * @return $this
     */
     ...
     * Sets records
     *
     * @param \Cyclos\Api\Model\RecordType[] $records Record types that operators of this group will only be able to access
     *
     * @return $this
     */
     ...
     * Gets accounts
     *
     * @return \Cyclos\Api\Model\OperatorGroupAccountView[]
     */
     ...
     * Sets accounts
     *
     * @param \Cyclos\Api\Model\OperatorGroupAccountView[] $accounts Settings for the access operators will have over owner accounts.
     *
     * @return $this
     */
     ...
     * Gets payments
     *
     * @return \Cyclos\Api\Model\OperatorGroupPaymentView[]
     */
     ...
     * Sets payments
     *
     * @param \Cyclos\Api\Model\OperatorGroupPaymentView[] $payments Settings for payments that can be performed by operators.
     *
     * @return $this
     */
