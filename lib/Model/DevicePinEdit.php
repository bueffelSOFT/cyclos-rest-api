...
/**
 * DevicePinEdit Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DevicePinEdit implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DevicePinEdit';
...
'name' => 'getName'    ];
     ...
     * Sets name
     *
     * @param string $name The new device PIN name. It must be unique per user.
     *
     * @return $this
     */
