 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DataForBalanceLimitsSearch implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataForBalanceLimitsSearch';
...
'account_types' => 'getAccountTypes'    ];
     ...
     * Sets groups
     *
     * @param \Cyclos\Api\Model\Group[] $groups The groups the authenticated user can use to filter.
     *
     * @return $this
     */
     ...
     * Sets account_types
     *
     * @param \Cyclos\Api\Model\AccountType[] $account_types The account types that can be used to filter.
     *
     * @return $this
     */
