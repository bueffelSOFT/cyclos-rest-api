 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeliveryMethod extends NamedEntity 
{
...
'charge_currency' => 'getChargeCurrency'    ];
     ...
     * Sets delivery_time
     *
     * @param  $delivery_time The maximum time interval expected for the products to be delivered.
     *
     * @return $this
     */
     ...
     * Sets charge_amount
     *
     * @param float $charge_amount The amount to be charged. Only makes sense if `chargeType` is `fixed`.
     *
     * @return $this
     */
     ...
     *
     * @param  $charge_currency The delivery price currency. Only makes sense if `chargeType` is `fixed`.
     *
     * @return $this
     */
