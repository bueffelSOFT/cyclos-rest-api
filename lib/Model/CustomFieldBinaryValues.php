 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomFieldBinaryValues implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomFieldBinaryValues';
    ...
    protected static $swaggerTypes = [
        'file_values' => 'map[string,\Cyclos\Api\Model\StoredFile[]]',
'image_values' => 'map[string,\Cyclos\Api\Model\Image[]]'    ];
...
'image_values' => 'getImageValues'    ];
     ...
     * Gets file_values
     *
     * @return map[string,\Cyclos\Api\Model\StoredFile[]]
     */
     ...
     * Sets file_values
     *
     * @param map[string,\Cyclos\Api\Model\StoredFile[]] $file_values The values for custom fields of type `file`
     *
     * @return $this
     */
     ...
     * Gets image_values
     *
     * @return map[string,\Cyclos\Api\Model\Image[]]
     */
     ...
     * Sets image_values
     *
     * @param map[string,\Cyclos\Api\Model\Image[]] $image_values The values for custom fields of type `image`
     *
     * @return $this
     */
