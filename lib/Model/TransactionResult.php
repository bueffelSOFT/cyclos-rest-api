 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransactionResult extends BaseTransactionResult 
{
...
'related_user' => 'getRelatedUser'    ];
     ...
     * Sets related_kind
     *
     * @param  $related_kind The related account owner kind
     *
     * @return $this
     */
     ...
     * Sets related_user
     *
     * @param  $related_user The user that either performed or received this transaction. Is only returned if `relatedKind` is `user`.
     *
     * @return $this
     */
