...
class ContactResult extends Contact 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContactResult';
     ...
     * Sets custom_values
     *
     * @param map[string,string] $custom_values Holds the values for contact custom fields which are set to be returned on list, keyed by field internal name
     *
     * @return $this
     */
