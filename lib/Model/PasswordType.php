 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PasswordType extends InternalNamedEntity 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PasswordType';
...
'mode' => 'getMode'    ];
     ...
     * Sets global
     *
     * @param bool $global Indicates whether this password type is defined in global mode (`true`) or in a network (`false`)
     *
     * @return $this
     */
