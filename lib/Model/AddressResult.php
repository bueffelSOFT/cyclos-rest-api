 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddressResult extends Address 
{
...
'hidden' => 'getHidden'    ];
     ...
     * Sets hidden
     *
     * @param bool $hidden Indicates whether this address is hidden for other users. It always returns false if the authenticated user doesn't manage the owner of this address.
     *
     * @return $this
     */
