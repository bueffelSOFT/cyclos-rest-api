 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RedeemVoucher implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RedeemVoucher';
     ...
     * Sets custom_values
     *
     * @param map[string,string] $custom_values Holds the custom field values for the redeem payment, keyed by field internal name or id. The format of the value depends on the custom field type.
     *
     * @return $this
     */
