 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DataForUserBalancesSearch extends BaseUserDataForSearch 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataForUserBalancesSearch';
...
'query' => 'getQuery'    ];
     ...
     * Sets account_types
     *
     * @param \Cyclos\Api\Model\EntityReference[] $account_types The available account types for the search
     *
     * @return $this
     */
     ...
     * Sets query
     *
     * @param  $query Default query parameters
     *
     * @return $this
     */
