 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeviceEdit implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeviceEdit';
...
'name' => 'getName'    ];
     ...
     * Sets name
     *
     * @param string $name The new device name. It must be unique per user.
     *
     * @return $this
     */
