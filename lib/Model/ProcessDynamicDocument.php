 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProcessDynamicDocument implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProcessDynamicDocument';
     ...
     * Sets form_fields
     *
     * @param map[string,string] $form_fields Holds the form field values, keyed by field internal name or id. The format of the value depends on the custom field type.
     *
     * @return $this
     */
