 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RecordDataForEdit extends RecordBasicData 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RecordDataForEdit';
...
'binary_values' => 'getBinaryValues'    ];
     ...
     *
     * @param string[] $editable_fields The internal names of fields that can be edited
     *
     * @return $this
     */
     ...
     * Sets record
     *
     * @param  $record The record that is being edited. This value can be modified and sent back to `PUT /records/{id}`
     *
     * @return $this
     */
