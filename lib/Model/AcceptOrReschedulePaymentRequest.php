 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AcceptOrReschedulePaymentRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AcceptOrReschedulePaymentRequest';
...
'process_date' => 'getProcessDate'    ];
     ...
     * Sets comments
     *
     * @param string $comments A comment the payer can set.
     *
     * @return $this
     */
     ...
     * Sets process_date
     *
     * @param \DateTime $process_date The date the payment request must be processed.
     *
     * @return $this
     */
