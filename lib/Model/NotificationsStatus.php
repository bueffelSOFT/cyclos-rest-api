 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NotificationsStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NotificationsStatus';
...
'last_view_date' => 'getLastViewDate'    ];
    ...
    {
        $this->container['new_notifications'] = isset($data['new_notifications']) ? $data['new_notifications'] : null;
        $this->container['unread_notifications'] = isset($data['unread_notifications']) ? $data['unread_notifications'] : null;
     ...
     *
     * @param int $new_notifications Indicates the number of received notifications after the last view date (i.e `lastViewDate`).
     *
     * @return $this
     */
     ...
     *
     * @param int $unread_notifications Indicates the total number of unread notifications.
     *
     * @return $this
     */
     ...
     * Sets last_view_date
     *
     * @param \DateTime $last_view_date The last view date tracked by the server through `POST /notifications/viewed`
     *
     * @return $this
     */
