 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TicketApprovalResult extends Entity 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TicketApprovalResult';
...
'ticket_status' => 'getTicketStatus'    ];
     ...
     * Sets cancel_url
     *
     * @param string $cancel_url The URL to redirect when canceling the accept ticket flow
     *
     * @return $this
     */
     ...
     * Sets success_url
     *
     * @param string $success_url The URL to redirect after successfully accepting a ticket
     *
     * @return $this
     */
     ...
     * Sets transaction
     *
     * @param  $transaction The generated payment. Only if `status` is `processed`.
     *
     * @return $this
     */
