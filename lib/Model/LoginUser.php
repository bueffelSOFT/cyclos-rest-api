 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LoginUser implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LoginUser';
...
'channel' => 'string',
'session_timeout' => 'AllOfLoginUserSessionTimeout'    ];
...
'session_timeout' => 'getSessionTimeout'    ];
     ...
     * Sets user
     *
     * @param string $user The user identification for login. The accepted kind of identification (login name, e-mail, etc) depend on the channel configuration.
     *
     * @return $this
     */
     ...
     * Sets password
     *
     * @param string $password The user password. The password type is set in the channel configuration.
     *
     * @return $this
     */
     ...
     * Sets remote_address
     *
     * @param string $remote_address The IP address of the user requesting the login.
     *
     * @return $this
     */
     ...
     * Sets channel
     *
     * @param string $channel The channel internal name. Defaults to `main`.
     *
     * @return $this
     */
     ...
     *
     * @return AllOfLoginUserSessionTimeout
     */
