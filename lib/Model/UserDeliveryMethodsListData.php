 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserDeliveryMethodsListData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserDeliveryMethodsListData';
...
'delivery_methods' => 'getDeliveryMethods'    ];
     ...
     * Sets can_manage
     *
     * @param bool $can_manage Indicates whether the delivery methods can be managed by the authenticated user
     *
     * @return $this
     */
     ...
     *
     * @param \Cyclos\Api\Model\DeliveryMethod[] $delivery_methods The delivery methods list
     *
     * @return $this
     */
