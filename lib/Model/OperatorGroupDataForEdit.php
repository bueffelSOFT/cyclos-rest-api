 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OperatorGroupDataForEdit extends OperatorGroupBasicData 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OperatorGroupDataForEdit';
...
'remove' => 'getRemove'    ];
     ...
     *
     * @param \Cyclos\Api\Model\User[] $restrict_payments_to_users Details of the currently set users in the `restrictPaymentsToUsers` property in `operatorGroup` (which have only the ids).
     *
     * @return $this
     */
     ...
     * Sets operator_group
     *
     * @param  $operator_group The operator group that is being edited. This value can be modified and sent back on `PUT /operator-groups/{id}`.
     *
     * @return $this
     */
     ...
     * Sets edit
     *
     * @param bool $edit Can the authenticated user edit this operator group?
     *
     * @return $this
     */
     ...
     * Sets remove
     *
     * @param bool $remove Can the authenticated user remove this operator group?
     *
     * @return $this
     */
