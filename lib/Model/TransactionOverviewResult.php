 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransactionOverviewResult extends BaseTransactionResult 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransactionOverviewResult';
...
'to_user' => 'getToUser'    ];
     ...
     * Sets from_kind
     *
     * @param  $from_kind The account owner kind of the transaction 'from'.
     *
     * @return $this
     */
     ...
     * Sets from_user
     *
     * @param  $from_user The 'from' user. Is only returned if `fromKind` is `user`.
     *
     * @return $this
     */
     ...
     * Sets to_kind
     *
     * @param  $to_kind The account owner kind of the transaction 'to'.
     *
     * @return $this
     */
     ...
     * Sets to_user
     *
     * @param  $to_user The 'from' user. Is only returned if `toKind` is `user`.
     *
     * @return $this
     */
