 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PasswordTypeRegistration extends InternalNamedEntity 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PasswordTypeRegistration';
...
'can_force_change' => 'getCanForceChange'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['can_force_change'] = isset($data['can_force_change']) ? $data['can_force_change'] : null;
    }
     ...
     * Sets description
     *
     * @param string $description The description to be show on the registration form
     *
     * @return $this
     */
     ...
     *
     * @param bool $can_force_change Whether the current user can set the password to be changed on the first user login
     *
     * @return $this
     */
