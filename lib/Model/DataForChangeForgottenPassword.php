 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DataForChangeForgottenPassword implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataForChangeForgottenPassword';
...
'security_question' => 'getSecurityQuestion'    ];
     ...
     * Sets generated
     *
     * @param bool $generated Indicates whether the password that is being affected is generated (when `true`) or manual (when `false`).
     *
     * @return $this
     */
     ...
     *
     * @param string $security_question If configured in Cyclos, and defined by the user, will be the security question that needs to be answered in order to complete the forgotten password reset request.
     *
     * @return $this
     */
