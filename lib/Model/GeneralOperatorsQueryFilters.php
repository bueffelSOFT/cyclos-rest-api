 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GeneralOperatorsQueryFilters extends BasicOperatorQueryFilters 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GeneralOperatorsQueryFilters';
...
'broker' => 'getBroker'    ];
     ...
     * Sets user_groups
     *
     * @param string[] $user_groups Either id or internal names of user groups / group sets
     *
     * @return $this
     */
     ...
     * Sets broker
     *
     * @param string $broker Either id or a principal (login name, e-mail, etc) of the user broker
     *
     * @return $this
     */
