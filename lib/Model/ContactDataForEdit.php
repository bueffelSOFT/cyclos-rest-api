 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContactDataForEdit extends ContactBasicData 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContactDataForEdit';
...
'binary_values' => 'getBinaryValues'    ];
     ...
     *
     * @param string[] $editable_fields The internal names of custom fields that can be edited
     *
     * @return $this
     */
     ...
     * Sets contact
     *
     * @param  $contact The contact that is being edited. This value can be modified and sent back to `PUT /contact/{id}`
     *
     * @return $this
     */
