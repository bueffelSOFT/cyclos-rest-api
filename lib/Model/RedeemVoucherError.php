...
class RedeemVoucherError extends Error 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RedeemVoucherError';
...
'payment_error' => '',
'code' => '\Cyclos\Api\Model\RedeemVoucherErrorCode',
'voucher_status' => '',
'allowed_days' => '\Cyclos\Api\Model\WeekDayEnum[]'    ];
...
'allowed_days' => 'getAllowedDays'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['voucher_status'] = isset($data['voucher_status']) ? $data['voucher_status'] : null;
        $this->container['allowed_days'] = isset($data['allowed_days']) ? $data['allowed_days'] : null;
    }
     ...
     *
     * @param \DateTime $redeem_after_date Indicates the date after which this voucher can be redeemed. Only if `code` is `notAllowedYet`.
     *
     * @return $this
     */
     ...
     * Gets code
     *
     * @return \Cyclos\Api\Model\RedeemVoucherErrorCode
     */
     ...
     * Sets code
     *
     * @param \Cyclos\Api\Model\RedeemVoucherErrorCode $code code
     *
     * @return $this
     */
     ...
     * Sets voucher_status
     *
     * @param  $voucher_status Only if `code` is `notAllowedForVoucher`
     *
     * @return $this
     */
     ...
     * Sets allowed_days
     *
     * @param \Cyclos\Api\Model\WeekDayEnum[] $allowed_days Only if `code` is `notAllowedToday`
     *
     * @return $this
     */
