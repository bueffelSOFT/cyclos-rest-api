 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BuyVoucher implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BuyVoucher';
...
'custom_values' => 'getCustomValues'    ];
     ...
     * Sets count
     *
     * @param int $count The number of vouchers to buy. Defaults to 1.
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param float $amount The amount per voucher
     *
     * @return $this
     */
     ...
     * Sets custom_values
     *
     * @param map[string,string] $custom_values Holds the payment custom field values, keyed by field internal name or id. The format of the value depends on the custom field type.
     *
     * @return $this
     */
