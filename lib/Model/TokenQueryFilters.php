 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TokenQueryFilters extends QueryFilters 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TokenQueryFilters';
...
'user' => 'string',
'value' => 'string',
'statuses' => '\Cyclos\Api\Model\TokenStatusEnum[]'    ];
...
'statuses' => 'getStatuses'    ];
     ...
     *
     * @param \DateTime[] $activation_period The minimum / maximum token activation date.
     *
     * @return $this
     */
     ...
     * Sets expiry_period
     *
     * @param \DateTime[] $expiry_period The minimum / maximum token expiry date.
     *
     * @return $this
     */
     ...
     * Sets user
     *
     * @param string $user Either id or a principal (login name, e-mail, etc) for the token owner user
     *
     * @return $this
     */
     ...
     * Sets statuses
     *
     * @param \Cyclos\Api\Model\TokenStatusEnum[] $statuses The desired token statuses
     *
     * @return $this
     */
