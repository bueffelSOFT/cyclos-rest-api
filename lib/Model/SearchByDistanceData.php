 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SearchByDistanceData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SearchByDistanceData';
...
'distance_unit' => 'getDistanceUnit'    ];
     ...
     * Sets addresses
     *
     * @param \Cyclos\Api\Model\Address[] $addresses The list of addresses owned by the authenticated user
     *
     * @return $this
     */
     ...
     * Sets default_values
     *
     * @param map[string,string] $default_values The default values, keyed by field name, for address fields
     *
     * @return $this
     */
