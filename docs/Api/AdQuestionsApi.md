# Cyclos\Api\AdQuestionsApi

All URIs are relative to *http://kb1.cyclos-dev.info/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**createAdQuestion**](AdQuestionsApi.md#createadquestion) | **POST** /marketplace/{ad}/questions | Creates a new advertisement question.
[**deleteAdQuestion**](AdQuestionsApi.md#deleteadquestion) | **DELETE** /questions/{id} | Removes an advertisement question.
[**getAdQuestion**](AdQuestionsApi.md#getadquestion) | **GET** /questions/{id} | Returns details of an advertisement question.

# **createAdQuestion**
> string createAdQuestion($body, $ad)
...
$apiInstance = new Cyclos\Api\Functions\AdQuestionsApi(
...
try {
    $result = $apiInstance->createAdQuestion($body, $ad);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AdQuestionsApi->createAdQuestion: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    $apiInstance->deleteAdQuestion($id);
} catch (Exception $e) {
    echo 'Exception when calling AdQuestionsApi->deleteAdQuestion: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getAdQuestion**
> \Cyclos\Api\Model\AdQuestionView getAdQuestion($id, $fields)
...
try {
    $result = $apiInstance->getAdQuestion($id, $fields);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AdQuestionsApi->getAdQuestion: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Cyclos\Api\Model\AdQuestionView**](../Model/AdQuestionView.md)
