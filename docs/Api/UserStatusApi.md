# Cyclos\Api\UserStatusApi

All URIs are relative to *http://kb1.cyclos-dev.info/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**changeUserStatus**](UserStatusApi.md#changeuserstatus) | **POST** /{user}/status | Sets the new user status
[**getUserStatus**](UserStatusApi.md#getuserstatus) | **GET** /{user}/status | Returns the current user status and the status history

# **changeUserStatus**
> changeUserStatus($body, $user)
...
$apiInstance = new Cyclos\Api\Functions\UserStatusApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \Cyclos\Api\Model\ChangeUserStatusParams(); // \Cyclos\Api\Model\ChangeUserStatusParams | The parameters for changing the status
...
try {
    $apiInstance->changeUserStatus($body, $user);
} catch (Exception $e) {
    echo 'Exception when calling UserStatusApi->changeUserStatus: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Cyclos\Api\Model\ChangeUserStatusParams**](../Model/ChangeUserStatusParams.md)| The parameters for changing the status |
...
# **getUserStatus**
> \Cyclos\Api\Model\UserStatusData getUserStatus($user, $fields)
...
try {
    $result = $apiInstance->getUserStatus($user, $fields);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling UserStatusApi->getUserStatus: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Cyclos\Api\Model\UserStatusData**](../Model/UserStatusData.md)
