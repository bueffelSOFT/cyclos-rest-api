...
[**getAddressDataForEdit**](AddressesApi.md#getaddressdataforedit) | **GET** /addresses/{id}/data-for-edit | Returns data to edit an existing address
...
[**getPasswordInputForRemoveAddress**](AddressesApi.md#getpasswordinputforremoveaddress) | **GET** /addresses/{id}/password-for-remove | Returns a confirmation &#x60;PasswordInput&#x60; for removing an address, if any
...
# **createAddress**
> string createAddress($body, $user, $confirmation_password)
...
$apiInstance = new Cyclos\Api\Functions\AddressesApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \Cyclos\Api\Model\AddressNew(); // \Cyclos\Api\Model\AddressNew | The address to be created
...
try {
    $result = $apiInstance->createAddress($body, $user, $confirmation_password);
    print_r($result);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Cyclos\Api\Model\AddressNew**](../Model/AddressNew.md)| The address to be created |
...
# **deleteAddress**
> deleteAddress($id, $confirmation_password)
...
try {
    $apiInstance->deleteAddress($id, $confirmation_password);
} catch (Exception $e) {
...
> \Cyclos\Api\Model\AddressDataForEdit getAddressDataForEdit($id, $fields)
...
try {
    $result = $apiInstance->getAddressDataForEdit($id, $fields);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AddressesApi->getAddressDataForEdit: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Cyclos\Api\Model\AddressDataForEdit**](../Model/AddressDataForEdit.md)
...
> \Cyclos\Api\Model\AddressDataForNew getAddressDataForNew($user, $fields)
...
try {
    $result = $apiInstance->getAddressDataForNew($user, $fields);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AddressesApi->getAddressDataForNew: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Cyclos\Api\Model\AddressDataForNew**](../Model/AddressDataForNew.md)
...
> \Cyclos\Api\Model\PasswordInput getPasswordInputForRemoveAddress($id, $fields)
...
try {
    $result = $apiInstance->getPasswordInputForRemoveAddress($id, $fields);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AddressesApi->getPasswordInputForRemoveAddress: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Cyclos\Api\Model\UserAddressesListData getUserAddressesListData($user, $fields)
...
try {
    $result = $apiInstance->getUserAddressesListData($user, $fields);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AddressesApi->getUserAddressesListData: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Cyclos\Api\Model\UserAddressesListData**](../Model/UserAddressesListData.md)
...
> \Cyclos\Api\Model\Address getUserPrimaryAddress($user, $fields)
...
try {
    $result = $apiInstance->getUserPrimaryAddress($user, $fields);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AddressesApi->getUserPrimaryAddress: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Cyclos\Api\Model\Address**](../Model/Address.md)
...
# **listAddressesByUser**
> \Cyclos\Api\Model\AddressResult[] listAddressesByUser($user, $fields)
...
try {
    $result = $apiInstance->listAddressesByUser($user, $fields);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AddressesApi->listAddressesByUser: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Cyclos\Api\Model\AddressResult[]**](../Model/AddressResult.md)
...
# **listCountries**
> \Cyclos\Api\Model\Country[] listCountries()
...
try {
    ...
    echo 'Exception when calling AddressesApi->listCountries: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Cyclos\Api\Model\Country[]**](../Model/Country.md)
...
# **updateAddress**
> updateAddress($body, $id, $confirmation_password)
...
$body = new \Cyclos\Api\Model\AddressEdit(); // \Cyclos\Api\Model\AddressEdit | The address to be edited
$id = "id_example"; // string | The object identification
$confirmation_password = "confirmation_password_example"; // string | The password used to confirm this action, if needed. The actual password type, if any, depends on the Cyclos configuration for the current channel.

try {
    $apiInstance->updateAddress($body, $id, $confirmation_password);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Cyclos\Api\Model\AddressEdit**](../Model/AddressEdit.md)| The address to be edited |
 **id** | **string**| The object identification |
 **confirmation_password** | **string**| The password used to confirm this action, if needed. The actual password type, if any, depends on the Cyclos configuration for the current channel. | [optional]
...
# **viewAddress**
> \Cyclos\Api\Model\AddressView viewAddress($id, $fields)
...
try {
    $result = $apiInstance->viewAddress($id, $fields);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AddressesApi->viewAddress: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Cyclos\Api\Model\AddressView**](../Model/AddressView.md)
